...
<div class="bg-white rounded-xl shadow-md p-6 max-w-5xl mx-auto">
  ...
  <form action="<?= base_url('kaprodi/profil/update') ?>" method="post" enctype="multipart/form-data" class="space-y-6">
    <?= csrf_field() ?>

    <!-- Nama -->
    <div>
      <label class="block font-medium mb-1">Nama</label>
      <input type="text" name="nama" value="<?= esc($kaprodi['nama_lengkap'] ?? '') ?>"
             class="w-full border rounded-lg px-4 py-2 focus:ring focus:ring-blue-300">
    </div>

    <!-- NIDN -->
    <div>
      <label class="block font-medium mb-1">NIDN</label>
      <input type="text" name="nidn" value="<?= esc($kaprodi['nidn'] ?? '') ?>"
             class="w-full border rounded-lg px-4 py-2 focus:ring focus:ring-blue-300">
    </div>
    ...
    <div>
      ...
      <input type="text" name="jabatan" value="<?= esc($kaprodi['jabatan'] ?? '') ?>"
             class="w-full border rounded-lg px-4 py-2 focus:ring focus:ring-blue-300">
    </div>
    ...
    <div>
      ...
      <input type="email" name="email" value="<?= esc($kaprodi['email'] ?? '') ?>"
             class="w-full border rounded-lg px-4 py-2 focus:ring focus:ring-blue-300">
    </div>
    ...
    <div>
      ...
      <input type="text" name="no_hp" value="<?= esc($kaprodi['notlp'] ?? '') ?>"
             class="w-full border rounded-lg px-4 py-2 focus:ring focus:ring-blue-300">
    </div>
