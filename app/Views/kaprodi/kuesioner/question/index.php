            ...
            <div class="col-lg-8">
                ...
                <div class="card mb-4" style="border: 1px solid #d1d5db; border-radius: 0.75rem; box-shadow: 0 1px 3px 0 rgba(0, 0, 0, 0.1);">
                    ...
                    <div class="card-body" id="formContainer" style="display: none; padding: 1.5rem;">
                        <form id="questionForm" action="<?= base_url("kaprodi/kuesioner/{$questionnaire_id}/pages/{$page_id}/sections/{$section_id}/questions/store") ?>" method="post" class="space-y-4">
                            <?= csrf_field() ?>
        ...
        `;
            ...
            document.addEventListener("click", function(e) {
                if (e.target.closest(".delete-question")) {
                    ...
                    if (confirm("Are you sure you want to delete this question?")) {
                        ...
                        fetch(`<?= base_url("kaprodi/kuesioner/{$questionnaire_id}/pages/{$page_id}/sections/{$section_id}/questions/delete/") ?>${questionId}`, {
                                method: 'POST',
                                headers: {
                ...
                if (e.target.closest(".duplicate-question")) {
                    ...
                    fetch(`<?= base_url("kaprodi/kuesioner/{$questionnaire_id}/pages/{$page_id}/sections/{$section_id}/questions/duplicate/") ?>${questionId}`, {
                            method: 'POST',
                            headers: {
                                'X-Requested-With': 'XMLHttpRequest',
            ...
            document.addEventListener("click", function(e) {
                if (e.target.closest(".edit-question")) {
                    ...
                    fetch(`<?= base_url("kaprodi/kuesioner/{$questionnaire_id}/pages/{$page_id}/sections/{$section_id}/questions/get/") ?>${questionId}`, {
                            method: 'GET',
                            headers: {
                                'X-Requested-With': 'XMLHttpRequest',
            ...
            document.getElementById('editQuestionForm').addEventListener('submit', function(e) {
                ...
                fetch(`<?= base_url("kaprodi/kuesioner/{$questionnaire_id}/pages/{$page_id}/sections/{$section_id}/questions/") ?>${questionId}/update`, {
                        method: 'POST',
                        body: formData,
                        headers: {
                            'X-Requested-With': 'XMLHttpRequest',
        ...
        `;
            ...
            window.loadEditConditionOptions = function() {
                ...
                if (parentId) {
                    ...
                    fetch(`<?= base_url("kaprodi/kuesioner/{$questionnaire_id}/pages/{$page_id}/sections/{$section_id}/questions/get-op/") ?>${parentId}`, {
                            method: 'GET',
                            headers: {
                                'X-Requested-With': 'XMLHttpRequest',
