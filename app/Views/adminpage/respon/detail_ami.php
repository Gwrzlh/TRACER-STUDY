...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4>📊 Detail Alumni - <span class="text-primary">AMI</span></h4>
        <a href="<?= base_url('admin/respon/ami'); ?>" class="btn btn-secondary btn-sm">
            <i class="bi bi-arrow-left"></i> Kembali
        </a>
    </div>

    <?php if (empty($alumni)) : ?>
        <div class="alert alert-warning">Tidak ada alumni yang termasuk dalam data AMI.</div>
    <?php else : ?>
        ...
        <div class="mb-3 text-end">
            <a href="<?= base_url('admin/respon/ami/pdf/' . urlencode($opsi)); ?>" target="_blank" class="btn btn-danger btn-sm">
