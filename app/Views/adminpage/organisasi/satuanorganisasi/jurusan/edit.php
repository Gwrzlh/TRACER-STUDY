        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('satuanorganisasi/jurusan/update/' . $jurusan['id']) ?>" method="post">
                        <?= csrf_field() ?>

                        <div class="mb-3">
                            <label for="nama_jurusan" class="form-label">Nama Jurusan:</label>
                            <input type="text" class="form-control" id="nama_jurusan" name="nama_jurusan"
                                   value="<?= old('nama_jurusan', isset($jurusan['nama_jurusan']) ? $jurusan['nama_jurusan'] : '') ?>" required>
                        </div>
