...
<div style="padding: 20px; background-color: #f8f9fa;">
    ...
    <div class="max-w-6xl mx-auto">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
            <h2 style="margin: 0; font-weight: 600; font-size: 24px; color: #333;">Satuan Organisasi</h2>
                    ...
                    <thead>
                        <tr style="background-color: #f8f9fa; border-bottom: 2px solid #e9ecef;">
                            <th style="padding: 16px 20px; 
                                      ...
                                      letter-spacing: 0.5px;">Nama Satuan</th>
                            <th style="padding: 16px 20px; 
                                      font-weight: 600; 
                                      font-size: 13px; 
                                      color: #495057; 
                                      text-align: left;
                                      text-transform: uppercase;
                                      letter-spacing: 0.5px;">Singkatan</th>
                            <th style="padding: 16px 20px; 
                                      font-weight: 600; 
                                      font-size: 13px; 
                                      color: #495057; 
                            ...
                            <th style="padding: 16px 20px; 
                                      ...
                                      text-align: left;
                                      text-transform: uppercase;
                                      letter-spacing: 0.5px;">Tipe Organisasi</th>
                            <th style="padding: 16px 20px; 
                                      font-weight: 600; 
                                      font-size: 13px; 
                                      color: #495057; 
                    ...
                    <tbody>
                        <?php foreach ($satuan as $row): ?>
                            <tr style="border-bottom: 1px solid #e9ecef; transition: background-color 0.2s ease;"
                                ...
                                <td style="padding: 16px 20px; font-size: 14px; color: #333; font-weight: 500;"><?= esc($row['nama_satuan']) ?></td>
                                <td style="padding: 16px 20px; font-size: 14px; color: #6c757d;"><?= esc($row['nama_singkatan']) ?></td>
                                <td style="padding: 16px 20px; font-size: 14px; color: #6c757d;"><?= esc($row['nama_slug']) ?></td>
