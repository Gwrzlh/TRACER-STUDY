...
<section class="hero animate__animated animate__fadeIn">
  <h1 class="animate__animated animate__fadeInDown"><?= esc($tentang['judul3']) ?></h1>
  <p class="animate__animated animate__fadeInUp animate__delay-1s">Kegiatan & Event Kami</p>
</section>
...
<main>
  <div class="container">
    <div class="event-section animate__animated animate__fadeInUp animate__delay-1s">
      ...
      <div class="event-image">
        <img src="<?= base_url('uploads/' . $tentang['gambar2']) ?>" alt="Gambar Event">
      </div>
      <?php endif; ?>
    </div>
  </div>
