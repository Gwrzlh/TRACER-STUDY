<?php
// File: app/Views/atasan/kuesioner/fill.php
?>
<!DOCTYPE html>
<html lang="id">
...
<head>
    <meta charset="UTF-8">
    <title>Isi Kuesioner Atasan</title>
...
<body>
    <div class="container mt-4">
                                        ...
                                        <?php elseif (strtolower($q['question_type']) === 'radio'): ?>
                                            <?php foreach ($options as $opt): ?>
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="radio-<?= $q['id'] ?>-<?= $opt['id'] ?>">
                                                        <?= esc($opt['option_text']) ?>
                                                    </label>
                                                </div>
                                            <?php endforeach; ?>
                                            ...
                                            <?php foreach ($options as $opt): ?>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="answer[<?= $q['id'] ?>][]" data-qid="<?= $q['id'] ?>"
                                                        ...
                                                        <?= in_array(($opt['option_value'] ?? $opt['option_text']), $existing_answers) ? 'checked' : '' ?>>
                                                    <label class="form-check-label" for="check-<?= $q['id'] ?>-<?= $opt['id'] ?>">
                                                        <?= esc($opt['option_text']) ?>
                                                    </label>
                                                </div>
                                            <?php endforeach; ?>
        ...
        <div class="mt-3">
            <a href="<?= base_url('atasan/kuesioner') ?>" class="btn btn-outline-secondary">Kembali</a>
        </div>
    </div>
