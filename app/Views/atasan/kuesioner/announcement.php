...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('css/atasan/kuesioner/announcement.css') ?>">
    ...
    <div class="announcement-container">
        <div class="announcement-card">
            <div class="announcement-header">
                ...
                <div class="announcement-title">Penilaian Diselesaikan</div>
            ...
            <div class="announcement-actions">
                <a href="<?= base_url('atasan/kuesioner') ?>" class="btn-continue">
