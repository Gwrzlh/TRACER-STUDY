...
.badge.bg-secondary {
    background-color: #dc3545 !important;  /* Red - Urgent/Not Started */
    color: white;
    box-shadow: 0 2px 4px rgba(220, 53, 69, 0.2);
}

.badge.bg-warning {
    background-color: #fd7e14 !important;  /* Orange - In Progress */
    color: white;
    box-shadow: 0 2px 4px rgba(253, 126, 20, 0.2);
}

.badge.bg-success {
    background-color: #198754 !important;  /* Green - Completed */
    color: white;
...
.btn-primary {
    background-color: #0d6efd;  /* Professional Blue - Start Action */
    border-color: #0d6efd;
    color: white;
...
.btn-warning {
    background-color: #fd7e14;  /* Orange - Continue Action (matches On Going status) */
    border-color: #fd7e14;
    color: white;
    box-shadow: 0 2px 4px rgba(253, 126, 20, 0.2);
}
...
.btn-success {
    background-color: #198754;  /* Green - View Action (matches Finish status) */
    border-color: #198754;
    color: white;
    box-shadow: 0 2px 4px rgba(25, 135, 84, 0.2);
}
