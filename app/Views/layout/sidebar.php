   ...
   <span>Dashboard</span>
        ...
        <details class="group" <?= str_contains($currentRoute, 'organisasi') ? 'open' : '' ?>>
          ...
          <div class="ml-8 mt-1 space-y-1">
            <a href="<?= base_url('satuanorganisasi')?>" class="no-underline flex items-center gap-2 px-2 py-1 rounded hover:text-black <?= $currentRoute == 'organisasi/struktur' ? 'text-blue-600 font-semibold' : 'text-gray-600' ?>">
              <!-- Icon Struktur -->
            ...
            <a href="<?=  base_url('/admin/tipeorganisasi')?>" class="no-underline flex items-center gap-2 px-2 py-1 rounded hover:text-black <?= $currentRoute == 'organisasi/prodi' ? 'text-blue-600 font-semibold' : 'text-gray-600' ?>">
              <!-- Icon Prodi -->
              <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2"
                   viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round"
